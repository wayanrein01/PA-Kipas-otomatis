...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button1.setOnClickListener {
            binding.button1.setBackgroundColor(ContextCompat.getColor(this, R.color.teal_700))
            binding.button2.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
            binding.button3.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
        ...
        binding.button2.setOnClickListener {
            binding.button2.setBackgroundColor(ContextCompat.getColor(this, R.color.teal_700))
            binding.button1.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
            binding.button3.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
        ...
        binding.button3.setOnClickListener {
            binding.button3.setBackgroundColor(ContextCompat.getColor(this, R.color.teal_700))
            binding.button2.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
            binding.button1.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOn))
    ...
    private fun switchUi() {
        if (binding.switchOtomatis.isChecked) {
            ...
            with(binding) {
                ...
                val delayTime: Long = 2000 // (2000 = 2 detik)
